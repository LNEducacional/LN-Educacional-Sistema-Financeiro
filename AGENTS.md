...
- `deploy.sh/` — explain what lives here and when agents should edit it.
...
- `OLD.md/` — explain what lives here and when agents should edit it.
- `requisitos.md/` — explain what lives here and when agents should edit it.
